...
rule iterateActionsA RuleB [openhab_rule]
    ...
    construct _ [openhab_rule]
        RuleB [enterFirstConditionLayer ActionA]
end rule

rule enterFirstConditionLayer ActionA [action_statement]
    ...
    construct _ [statement]
        S   [iterateActionsB ActionA]
    construct _ [opt else_clause]
        EC  [iterateActionsB ActionA]
end rule
...
function insertCondition ActionA [action_statement] ActionB [action_statement]
